...
public class Product {
	...
	@Column(columnDefinition = "TEXT") //para conseguir armazenar textos muito longos
	...
	public Product(Long id, String name, String description, Double price, String imgUrl, Instant date) {
		//OBS: não instancia no constructor a Categorie
		this.id = id;
		this.name = name;
...
//  Não tem pq eu permitir que o conjunto de categorias seja trocado, somente acrescentar e remover, mas não trocar
